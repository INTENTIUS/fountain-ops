...
| **Does not work** | Completing a turn — sometimes. It is a race, it fails cleanly when it loses, and completing reliably needs [spritzer#18](https://github.com/INTENTIUS/spritzer/issues/18) |
